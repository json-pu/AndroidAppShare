 ...
 * 
 * the authorities must be you package name puls ".assetprovider"
 * 
 * 这个类来自Google的分享sample，主要是assets目录的内容提供者
 * 须要在AndroidManifest.xml中注册
 * authorities是你的程序包名加上 ".assetprovider"
 */
 ...
 * 
 * this class is provider for assets folder。
 * the authorities must be you package name plus ".fileprovider"
 * 
 * 这个类是Android 项目文件assets的内容提供者 须要在AndroidManifest.xml中注册
...
public class AssetProvider extends ContentProvider {
    ...
    public boolean onCreate() {
    	CONTENT_URI=getContext().getPackageName()+".assetprovider";
        return true;
    }
